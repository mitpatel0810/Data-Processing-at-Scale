...
INPUT_FILE_PATH = 'C:\Users\Mit\'s Laptop\Desktop\d1.txt'
ACTUAL_ROWS_IN_INPUT_FILE = 100001  # Number of lines in the input file
...
if __name__ == '__main__':
    try:
        ...
        with testHelper.getOpenConnection(dbname=DATABASE_NAME) as conn:
            ...
            [result, e] = testHelper.testrangeinsert(MyAssignment, RATINGS_TABLE, 100, 2, 2, conn, '1')
